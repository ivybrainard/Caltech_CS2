...
public interface IStyleTests {
    ...
    default void testForInvalidClasses() {
        List<String> regexps = List.of("java\\.util\\.(?!Iterator|Random|function.Function|ArrayList|List|Scanner|Map|HashMap)", "java\\.lang\\.reflect", "java\\.io\\.(?!File|FileNotFoundException)");
